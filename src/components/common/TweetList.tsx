        ...
        {tweets.map((tweet) => (
          <Card key={tweet.id} className="bg-gray-800/70 backdrop-blur-sm shadow-xl border-gray-700">
            ...
            <CardFooter className="flex gap-4 text-gray-400">
              <button onClick={() => handleLike(tweet.id)} className="flex items-center gap-1 hover:text-orange-400 transition-colors">
              ...
              >
                ...
                <DialogContent className="bg-gray-800 border-gray-700">
                  ...
                  <div className="space-y-4">
                    ...
                    />
                    <Button onClick={() => handleResponse(tweet.id)} className="w-full bg-gradient-to-r from-orange-400 to-orange-500 hover:from-orange-500 hover:to-orange-600 text-white">
                      답글 작성
                    </Button>
                  </div>
                </DialogContent>
